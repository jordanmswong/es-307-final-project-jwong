...
biomass_subplots <- byTileAOP(dpID="DP3.30016.001", site="SJER", year="2019", easting=easting, northing=northing, buffer=20, check.size = F)
...
mean(biomass_full_df$layer)
sd(biomass_full_df$layer)
```
