...
biomass_subplots_df_2 <- as.data.frame(biomass_subplots, xy=TRUE)
crs(biomass_subplots)


# Reproject biomass subplot raster
biomass_subplots_latlong <- projectRaster(biomass_subplots, crs=crs(subplot_points_SJER))
crs(biomass_subplots_latlong)

biomass_subplots_df <- as.data.frame(biomass_subplots_latlong, xy= TRUE)

# Check original crs to be sure
crs(subplot_points_SJER)
